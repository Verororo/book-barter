...
namespace BookBarter.Infrastructure.Migrations
{
    ...
    [Migration("20250527140442_RelationshipsAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookUser", b =>
                {
                    b.Property<int>("BooksWantedId")
                        .HasColumnType("int");

                    b.Property<int>("UsersWantedById")
                        .HasColumnType("int");

                    b.HasKey("BooksWantedId", "UsersWantedById");

                    b.HasIndex("UsersWantedById");

                    b.ToTable("UserWantsBook", (string)null);
                });
            ...
            modelBuilder.Entity("BookUser", b =>
                {
                    b.HasOne("BookBarter.Domain.Entities.Book", null)
                        .WithMany()
                        .HasForeignKey("BooksWantedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BookBarter.Domain.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UsersWantedById")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
