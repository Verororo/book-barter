...
import {
  PublishersApi,
  type CreatePublisherCommand,
  type GetPagedPublishersForModerationQuery,
  type PublisherDto,
  type PublisherForModerationDtoPaginatedResult,
  type UpdatePublisherCommand,
} from '../generated';
...
export const approvePublisher = async (id: number) => {
  await publishersApi.apiPublishersIdApprovePut(id);
};

export const updatePublisher = async (query: UpdatePublisherCommand) => {
