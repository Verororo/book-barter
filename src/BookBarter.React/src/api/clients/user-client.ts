...
import {
  mapListedUserPaginatedResultDtoToView,
  type ListedUserPaginatedResult,
} from '../view-models/listed-user-paginated-result';
...
export const updateUser = async (query: UpdateUserCommand) => {
...
export const addBookToOwned = async (query: AddOwnedBookCommand) => {
  await usersApi.apiUsersMeOwnedBooksPost(query);
};

export const deleteBookFromOwned = async (query: DeleteOwnedBookCommand) => {
  await usersApi.apiUsersMeOwnedBooksBookIdDelete(query.bookId!, query);
};

export const addBookToWanted = async (query: AddWantedBookCommand) => {
  await usersApi.apiUsersMeWantedBooksPost(query);
};

export const deleteBookFromWanted = async (query: DeleteWantedBookCommand) => {
