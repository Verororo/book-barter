  ...
  return {
    ...
    async apiCitiesPagedPost(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<CityDtoPaginatedResult>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiCitiesPagedPost(
          getPagedCitiesQuery,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['CitiesApi.apiCitiesPagedPost']?.[
...
export const CitiesApiFactory = function (
  ...
  return {
    ...
    apiCitiesPagedPost(
      ...
      return localVarFp
        .apiCitiesPagedPost(getPagedCitiesQuery, options)
