...
export const BooksApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        apiBooksIdDelete: async (id: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        apiBooksIdGet: async (id: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        apiBooksIdPut: async (id: number, updateBookCommand?: UpdateBookCommand, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        apiBooksPagedPost: async (getPagedBooksQuery?: GetPagedBooksQuery, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(getPagedBooksQuery, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        apiBooksPost: async (createBookCommand?: CreateBookCommand, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const BooksApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async apiBooksIdGet(id: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BookDto>> {
         ...
         * @throws {RequiredError}
         */
        async apiBooksIdPut(id: number, updateBookCommand?: UpdateBookCommand, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * @throws {RequiredError}
         */
        async apiBooksPagedPost(getPagedBooksQuery?: GetPagedBooksQuery, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BookDtoPaginatedResult>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.apiBooksPagedPost(getPagedBooksQuery, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['BooksApi.apiBooksPagedPost']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
...
export const BooksApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        apiBooksIdGet(id: number, options?: RawAxiosRequestConfig): AxiosPromise<BookDto> {
         ...
         * @throws {RequiredError}
         */
        apiBooksPagedPost(getPagedBooksQuery?: GetPagedBooksQuery, options?: RawAxiosRequestConfig): AxiosPromise<BookDtoPaginatedResult> {
            return localVarFp.apiBooksPagedPost(getPagedBooksQuery, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {CreateBookCommand} [createBookCommand] 
...
export class BooksApi extends BaseAPI {
     ...
     * @memberof BooksApi
     */
    public apiBooksPagedPost(getPagedBooksQuery?: GetPagedBooksQuery, options?: RawAxiosRequestConfig) {
        return BooksApiFp(this.configuration).apiBooksPagedPost(getPagedBooksQuery, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof BooksApi
     */
    public apiBooksPost(createBookCommand?: CreateBookCommand, options?: RawAxiosRequestConfig) {
        return BooksApiFp(this.configuration).apiBooksPost(createBookCommand, options).then((request) => request(this.axios, this.basePath));
    }
}
